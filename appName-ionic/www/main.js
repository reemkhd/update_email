...
const routes = [
    ...
    {
        path: 'landing',
        loadChildren: () => Promise.all(/*! import() | pages-landing-landing-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-landing-landing-module")]).then(__webpack_require__.bind(null, /*! ./pages/landing/landing.module */ "CXjK")).then(m => m.LandingPageModule)
    },
    {
        path: 'login',
        loadChildren: () => Promise.all(/*! import() | pages-auth-login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-auth-login-login-module")]).then(__webpack_require__.bind(null, /*! ./pages/auth/login/login.module */ "qdgq")).then(m => m.LoginPageModule)
    },
    {
        path: 'register',
        loadChildren: () => Promise.all(/*! import() | pages-auth-register-register-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-auth-register-register-module")]).then(__webpack_require__.bind(null, /*! ./pages/auth/register/register.module */ "+iOL")).then(m => m.RegisterPageModule)
    },
    {
        path: 'dashboard',
